...
보종_분류_규칙 = """- 보종: 광고의 핵심 보험 상품(소재명)을 아래 규칙에 따라 분류하세요. 반드시 우선순위 순서대로 적용하세요.
  ...
  8. 골프플랜: 골프, 홀인원
  9. 여행보험: 여행, 여행자보험, 해외여행, 해외여행자, 출국, 유학, 출장, 여권, 항공권
     예) 해외여행보험->여행보험, 여행자보험->여행보험, 유학생보험->여행보험
  10. 펫보험: 펫, 강아지, 고양이, 반려동물
  11. 자동차: 자동차, 차량, 자차, 자동차보험
  12. 보장분석: 보장분석, 보험점검, 보험진단, 보험리모델링, 리모델링
  13. 연령제한보험: 특정 연령을 타겟으로 하는 종합보험. 20대, 30대, 40대, 50대, 60대, 2030, 3040, 4050, 5060, 1040,
  ...
  14. 종합보험: 위 카테고리에 해당하지 않는 일반 보험
      예) 한아름종합보험->종합보험, 값진인생보험->종합보험, 건강보험->종합보험, 종합보험->종합보험
  15. 위 규칙에 모두 해당하지 않으면 미분류

  최종 우선순위: 여성보험 > 태아보험 > 어린이보험 > 암보험 > 간병인보험 > 운전자 > 주택화재 > 골프플랜 > 여행보험 > 펫보험 > 자동차 > 보장분석 > 연령제한보험 > 종합보험 > 미분류"""
